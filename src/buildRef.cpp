...
// Mapping file related data and functions

int mappingType; // 0, no mapping; 1, transcript-level; 2, allele-level
int mappingPos; // position in the argv vector
