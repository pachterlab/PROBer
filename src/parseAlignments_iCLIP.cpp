...
int main(int argc, char* argv[]) {
  if (argc < 8) { 
    printf("PROBer-parse-alignments-iCLIP refName imdName statName channel number_of_partitions alignFType('s' for sam, 'b' for bam) alignF [-m max_hit_allowed][--shorter-than min_len] [-q]\n");
    exit(-1);
  }
